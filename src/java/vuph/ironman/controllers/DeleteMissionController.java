...
public class DeleteMissionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.removeMissionOfOne(missionId, avengerId);
        } catch (Exception e) {
            log("ERROR at IronmanDeleteMissionController: " + e.getMessage());
        } finally {
            request.getRequestDispatcher("ViewMissionController").forward(request, response);
        }
    }
