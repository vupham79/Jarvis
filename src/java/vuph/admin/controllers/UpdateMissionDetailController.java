...
public class UpdateMissionDetailController extends HttpServlet {
    private static final String EDIT = "mission/update_mission_details.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Edit")) {
                ...
                dao.updateMissionDetail(status, missionId, avengerId);
                url = SUBMIT;
            }
        } catch (Exception e) {
            log("ERROR at UpdateMissionDetailController: " + e.getMessage());
        } finally {
