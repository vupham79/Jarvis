...
public class DeleteAvengerController extends HttpServlet {
    ...
    private static final String SUCCESS = "ViewAvengerController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.removeAvenger(avengerId);
            url = SUCCESS;
        } catch (Exception e) {
            log("ERROR at DeleteAvengerController: " + e.getMessage());
            request.setAttribute("ERROR", "Delete Avenger Failed!");
            url = SUCCESS;
        } finally {
